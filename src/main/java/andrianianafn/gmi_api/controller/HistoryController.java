...
public class HistoryController {
    ...
    @PostMapping
    private ResponseEntity<History> creatNewMovement(@RequestBody HistoryRequestDto historyRequestDto,@RequestHeader (name = HttpHeaders.AUTHORIZATION) String authorizationHeader){
